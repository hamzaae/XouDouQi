    ...
    public static void actions(JFrame frame){
        ...
        frame.addMouseListener(new MouseListener() {
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                if (animalMoved) {
                    //randomPlayer(frame);
                    //aiMove(new Board(getBoardCurrent()),frame);
                    //changePlayer(frame);
                    //Minimax.Move move = Minimax.minimaxIt(animals, 5, true);
                    //System.out.println(move.animal);
                    //System.out.println(move.position);
                    /*for (Animal animal:animals){
                        if (move.animal.getPlayer().getUsername().equals("1") && animal.getName().equals(move.animal.getName())){
                            animal.setPosition(move.animal.getPosition());
                        }
                    }*/
                    changePlayer();
                    frame.repaint();
